...
def _create_pyg_from_pdp_data(
    ...
    # Features: [norm_x, norm_y, is_depot, is_pickup, is_delivery, norm_demand, norm_tw_start, norm_tw_end]
...
def validate_pdp_solution(
    ...
    if not pd_pairs:
        ...
        return is_valid, (
            ...
            if is_valid
            else "Error: Invalid tour for no-customer case."
        )
    ...
    return True, "Tour is valid (P-D constraints only)."
